...
async def playlist(client, message):
    ...
    msg = "**Sedang Diputar** in {}".format(message.chat.title)
    msg += "\n- " + now_playing
    msg += "\n- Req by " + by
    temp.pop(0)
    if temp:
...
async def play(_, message: Message):
        ...
        for administrator in administrators:
            if administrator == message.from_user.id:
                if message.chat.title.startswith("Channel Music: "):
                    await lel.edit(
                        "<b>Jangan lupa tambahkan asisten ke channel</b>",
                    )
                    pass
                try:
                    ...
                    await lel.edit(
                        "<b>Pertama jadikan admin dalam group</b>",
                    )
                    return
                ...
                try:
                    ...
                    await USER.send_message(
                        message.chat.id, "Saya join untuk memutar lagu dalam VC"
                    )
                    await lel.edit(
                        "<b>asisten telah join di chat</b>",
                    )
    ...
    try:
        ...
        await lel.edit(
            f"<i> {user.first_name} Userbot not in this chat, Ask admin to send /play command for first time or add {user.first_name} manually request here @asistenmusik2 with your group link</i>"
        )
        return
    text_links=None
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://telegra.ph/file/66fc2267158df2d14ad9f.jpg"
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="▶️ **Memutar** Lagu ini di requested by {} via Youtube Music 😜".format(
...
async def ytplay(_, message: Message):
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        await message.reply_photo(
            photo="final.png",
            caption=f"#⃣ Lagu di requested **queued** di posisi {position}!",
            reply_markup=keyboard,
        )
        os.remove("final.png")
        return await lel.delete()
...
async def deezer(client: Client, message_: Message):
        ...
        for administrator in administrators:
            if administrator == message_.from_user.id:
                ...
                try:
                    await USER.join_chat(invitelink)
                    await USER.send_message(
                        message_.chat.id, "Saya join untuk memutar lagu dalam VC"
                    )
                    await lel.edit(
                        "<b>asisten telah join di chat</b>",
                    )
    ...
    try:
        ...
        thumbnail = "https://telegra.ph/file/66fc2267158df2d14ad9f.jpg"
...
async def jiosaavn(client: Client, message_: Message):
    ...
    try:
        ...
        await lel.edit(
            "<i> helper Userbot not in this chat, Ask admin to send /play command for first time or add assistant manually request here @asistenmusik2 with your group link</i>"
        )
        return
    requested_by = message_.from_user.first_name
    chat_id = message_.chat.id
...
async def lol_cb(b, cb):
    ...
    if cb.from_user.id != useer_id:
        ...
        return
    await cb.message.edit("Harap menunggu... Mulai Memutar Lagu")
    x=int(x)
    try:
    ...
    if chat_id in callsmusic.pytgcalls.active_calls:
        ...
        await b.send_photo(chat_id,
            photo="final.png",
            reply_markup=keyboard,
            caption=f"▶️ **Memutar Musik** lagu ini di req by{r_by.mention} via Youtube Music 😜",
        )
